...
insert into appointments (date,hour,id_user,id_service,state) values ('2024-06-29', '14:00:00',2,2,1);
insert into appointments (date,hour,id_user,id_service,state) values ('2024-06-29', '13:00:00',2,1,1);
insert into appointments (date,hour,id_user,id_service,state) values ('2024-06-25', '13:00:00',13,6,1);
insert into appointments (date,hour,id_user,id_service,state) values ('2024-06-17', '13:00:00',12,7,1);
insert into appointments (date,hour,id_user,id_service,state) values ('2024-06-20', '13:00:00',3,12,1);